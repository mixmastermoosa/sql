...
Please click on the unique links below to view the query and results in your browser, no authentication is required.  
...
Analysis:  The 7 day rolling average of new positive cases has been on the decline since the beginning of the month.  
...
Analysis:  Puerto Rico has a 1.4x higher % positivity rate than Michigan, which has the 2nd highest positivity rate in the table.  However, Puerto Rico is 4x higher in COVID positivity when compared to New York, which has the 10th highest posivity rate in the table.
